    ...
    vlSelf->rs1_data = ((0U == (IData)(vlSelf->rs1_addr))
                         ? 0U : (((IData)(vlSelf->we) 
                                  & ((IData)(vlSelf->rd_addr) 
                                     == (IData)(vlSelf->rs1_addr)))
                                  ? vlSelf->rd_data
                                  : vlSelf->regfile__DOT__regs
                                 [vlSelf->rs1_addr]));
    vlSelf->rs2_data = ((0U == (IData)(vlSelf->rs2_addr))
                         ? 0U : (((IData)(vlSelf->we) 
                                  & ((IData)(vlSelf->rd_addr) 
                                     == (IData)(vlSelf->rs2_addr)))
                                  ? vlSelf->rd_data
                                  : vlSelf->regfile__DOT__regs
                                 [vlSelf->rs2_addr]));
}
...
VL_INLINE_OPT void Vregfile___024root___nba_sequent__TOP__0(Vregfile___024root* vlSelf) {
    ...
    __Vdlyvdim0__regfile__DOT__regs__v0 = 0;
    IData/*31:0*/ __Vdlyvval__regfile__DOT__regs__v0;
    __Vdlyvval__regfile__DOT__regs__v0 = 0;
    CData/*0:0*/ __Vdlyvset__regfile__DOT__regs__v0;
    __Vdlyvset__regfile__DOT__regs__v0 = 0;
    // Body
    __Vdlyvset__regfile__DOT__regs__v0 = 0U;
    if (((IData)(vlSelf->we) & (0U != (IData)(vlSelf->rd_addr)))) {
        __Vdlyvval__regfile__DOT__regs__v0 = vlSelf->rd_data;
        __Vdlyvset__regfile__DOT__regs__v0 = 1U;
        __Vdlyvdim0__regfile__DOT__regs__v0 = vlSelf->rd_addr;
    }
...
#endif
            VL_FATAL_MT("rtl/regfile.sv", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("rtl/regfile.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("rtl/regfile.sv", 1, "", "Active region did not converge.");
            }
